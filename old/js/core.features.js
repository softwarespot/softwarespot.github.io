...
App.namespace('core').features = (function featuresModule(window, document, $, core) {
    ...
    var _hasGeoLocation = core.isObject(_nativeNavigator) && 'geolocation' in _nativeNavigator;

    var _hasHistory = core.isObject(_nativeHistory) && 'pushState' in _nativeHistory;
    ...
    var _hasNotification =
        core.isFunction(_nativeNotification) &&
        (_nativeNotification.permission === 'granted' || core.isFunction(_nativeNotification.requestPermission));

    var _hasPromise =
        core.isFunction(_nativePromise) &&
